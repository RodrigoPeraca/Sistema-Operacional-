...
/**
 * Adaptador de GerenciadorLiberacao para WorstFitSynchronized.
 */
public class GerenciadorLiberacaoSynchronized {

    private static final double META_LIVRE = 0.30;

    private final WorstFitSynchronized worstFit;
    private final Random random;

    public GerenciadorLiberacaoSynchronized(WorstFitSynchronized worstFit) {
        if (worstFit == null)
            throw new IllegalArgumentException("WorstFitSynchronized não pode ser nulo");
